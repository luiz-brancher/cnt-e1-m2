  ...
  var print_default_path = '../html/assets/print/';
  var leitor_default_path = '../html/assets/print/';
  var bootstrap_path = '../html/assets/bootstrap/';
  var default_css_path = '../html/assets/css/';
  var fa_path = '../html/assets/fa/css/' ;
  var js_path = '../html/assets/js/';
  var img_path = '../html/assets/img/';
  ...
  function layoutLeitor(){
    ...
    HTMLstring+='<script language="javascript">$(function (){ $(".conteudo").css("display","block");});</script>\n'
    HTMLstring+='<script language="javascript">$(function (){ $(".modal-fullscreen").css("display","block");});</script>\n'
    HTMLstring+='</body>\n';
    HTMLstring+='</html>';
